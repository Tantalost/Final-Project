...
<head>
  ...
  <link rel="stylesheet" href="/CSS/damagebookrep.css">
</head>
  ...
  <div class="container">
      ...
      <main class="main-content" id="mainContent">
          ...
          <div class="header-actions">
            <div class="count-display"><span class="count">6</span> Damage Books Reports</div>
            </div>
  ...
  <div class="modal-content">
    ...
    <div class="modal-actions">
     ...
     <script>
      ...
      // View report details modal open/close
